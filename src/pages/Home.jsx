                                            ...
                                            <>
                                                <tr key={index} className="border-b dark:border-gray-700">
                                                    ...
                                                    <td className="px-4 py-3 flex items-center justify-end">
                                                        <button
                                                            id={`apple-imac-27-dropdown-button-${index}`}
                                                            data-dropdown-toggle={`apple-imac-27-dropdown-${index}`}
                                                        ...
                                                        >
                                                            <ul
                                                                ...
                                                                aria-labelledby={`apple-imac-27-dropdown-button-${index}`}
                                                            >
                                                                <li>
                                                                    <button
                                                                        type="button"
                                                                ...
                                                                <li>
                                                                    <button
                                                                        type="button"
                                                                        data-modal-target={`readProductModal-${index}`}
                                                                        data-modal-toggle={`readProductModal-${index}`}
                                                                        className="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200"
                                                                    >
                                                                        <svg
                                                                            className="w-4 h-4 mr-2"
                                                                ...
                                                                <li>
                                                                    <button
                                                                        type="button"
                                                                        data-modal-target="deleteModal-0"
                                                                        data-modal-toggle="deleteModal-0"
                        ...
                        <div className="flex justify-between mb-4 rounded-t sm:mb-5">
                            ...
                            <div>
                                <button
                                    ...
                                    data-modal-toggle="readProductModal-0"
                                >
                                    <svg
                                        aria-hidden="true"
                                        className="w-5 h-5"
